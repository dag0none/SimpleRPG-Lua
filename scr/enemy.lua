function createEnemy()
    local this = {
        ...
        amount_atk = cardField[enemyData.index].amount_atk,
        value_atk = cardField[enemyData.index].value_atk,
...
function drawEnemy(_enemy)
    ...
    love.graphics.print("attack: " .. tostring(_enemy.amount_atk) .. "-" .. tostring(_enemy.value_atk), _enemy.x + 40, _enemy.y + 26)
